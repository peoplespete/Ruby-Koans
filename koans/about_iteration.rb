...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # it takes the values and iterates over them and assigns values computed to itself
    # the number arg given to inject is the starting value for "sum" or "product"
  end
  ...
  #   # code to read 'file'
  #
  # perhaps this is asyncranous code.  so you need to have file opened before you would do
    # stuff and the second way would begin trying to read the file before the previous line
    # finishes opening it
